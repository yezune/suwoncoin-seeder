...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Suwoncoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed1.suwoncoin.org", "dnsseed2.suwoncoin.org", ""};
static const string testnet_seeds[] = {"dnsseed3.suwoncoin.org", ""};
